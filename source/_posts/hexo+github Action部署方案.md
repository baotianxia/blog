...
接着，把你本地的hexo文件上传到`main`分支下。获取一个ssh，将公钥上传至github[SSH keys](https://github.com/settings/keys)，私钥作为Repository secrets上传到[Action secrects](https://github.com/baotianxia/blog/settings/secrets/actions)，不妨设name为`SSH_PRIVATE_KEY`。
